...
public class InterfazImpuestosCarro extends JFrame {
    ...
    public void buscarPorLinea() {
        ...
        //se realiza configuracion para entrada de texto de la linea a buscar
        String lineaBuscar = JOptionPane.showInputDialog("Ingrese la linea a buscar:");
        System.out.println("buscar:"+ lineaBuscar);
        Vehiculo respuesta = calculador.buscarVehiculoPorLinea(lineaBuscar);
        if (respuesta == null) {
    ...
    public void buscarPorMarca() {
        //se realiza configuracion para entrada de texto de la marca a buscar
    	String marcaBuscar = JOptionPane.showInputDialog("Ingrese la marca a buscar:");
    	System.out.println("buscar:"+ marcaBuscar);
        Vehiculo respuesta = calculador.buscarVehiculoPorMarca(marcaBuscar);
        if (respuesta == null) {
